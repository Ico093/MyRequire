...
QUnit.test('Module not loaded', function (assert) {
...
QUnit.test('Require wrong 1st argument', function (assert) {
    assert.throws(function () {
...
QUnit.test('Require wrong 2nd argument', function (assert) {
    assert.throws(function () {
        require([], 'Test');
...
QUnit.test('Define wrong 1st argument', function (assert) {
    assert.throws(function () {
        define([], [], function () {
        });
...
QUnit.test('Require wrong 3rd argument', function (assert) {
    assert.throws(function () {
        define('module1', [], 'Test');
